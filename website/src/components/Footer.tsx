        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <div className="flex space-x-6">
              <a href="https://github.com/PenguinCloud/WaddlePerf" className="text-gray-400 hover:text-gray-300">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li><a href="https://github.com/PenguinCloud/WaddlePerf/releases" className="text-base text-gray-400 hover:text-white">Download</a></li>
                  <li><a href="https://github.com/PenguinCloud/WaddlePerf" className="text-base text-gray-400 hover:text-white">GitHub</a></li>
                </ul>
              </div>
              <div className="mt-12 md:mt-0">
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li><a href="/docs/api" className="text-base text-gray-400 hover:text-white">API Reference</a></li>
                </ul>
              </div>
            </div>
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  <li><a href="https://github.com/PenguinCloud/WaddlePerf/issues" className="text-base text-gray-400 hover:text-white">GitHub Issues</a></li>
